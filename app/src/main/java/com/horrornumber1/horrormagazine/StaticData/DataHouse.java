...
public class DataHouse {
    ...
    //************************************Drawer Navigation1****************************************
    public static List<MyData> drawerData = new ArrayList<MyData>()
    {
        {
            add(new MyData("지역괴담",R.drawable.radio_icon));
            add(new MyData("군대괴담", R.drawable.millitary_icon));
            add(new MyData("실제이야기", R.drawable.real_icon));
            add(new MyData("대학괴담", R.drawable.college_icon));
            //add(new MyData("4컷만화", R.drawable.cartoon_icon));
            add(new MyData("로어", R.drawable.roar_icon));
            add(new MyData("이해하면 무서운 이야기", R.drawable.understand_icon));
            add(new MyData("도시괴담", R.drawable.city_icon));
        }
    };
    //************************************Drawer Navigation2****************************************
