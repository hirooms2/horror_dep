package com.horrornumber1.horrormagazine.StaticData;
...
public class DataHouse {
    ...
    {
        {
            add(new MyData("고양시 괴담",0,R.raw.region01));
            add(new MyData("용산 괴담",0,R.raw.region02));
            add(new MyData("송파 괴담",0,R.raw.region03));
            add(new MyData("동대문 괴담",0,R.raw.region04));
            add(new MyData("화성시 괴담",0,R.raw.region05));
            add(new MyData("평택시 괴담",0,R.raw.region06));
            add(new MyData("대전 괴담",0,R.raw.region07));
            add(new MyData("아산 괴담",0,R.raw.region08));
            add(new MyData("아산 괴담2",0,R.raw.region09));
            add(new MyData("천안 괴담",0,R.raw.region10));
            add(new MyData("당진 괴담",0,R.raw.region11));
            add(new MyData("속초 괴담",0,R.raw.region12));
            add(new MyData("원주 괴담",0,R.raw.region13));
            add(new MyData("원주 괴담2",0,R.raw.region14));
            add(new MyData("영주 괴담",0,R.raw.region15));
            add(new MyData("부산 괴담",0,R.raw.region16));
            add(new MyData("대구 괴담",0,R.raw.region17));
            add(new MyData("울산 괴담",0,R.raw.region18));
            add(new MyData("대구 괴담2",0,R.raw.region19));
            add(new MyData("부산 괴담2",0,R.raw.region20));
            add(new MyData("여수 괴담",0,R.raw.region21));
            add(new MyData("전주 괴담",0,R.raw.region22));
            add(new MyData("순천 괴담",0,R.raw.region23));
            add(new MyData("광주 괴담",0,R.raw.region24));
            add(new MyData("서귀 괴담",0,R.raw.region25));
    ...
    {
        {
            ...
            add(new MyData("육군 21시단-노래소리",0,R.raw.millitary11));
            add(new MyData("육군 21시단-낫을 든 손",0,R.raw.millitary12));
            ...
            add(new MyData("공군-쓰리고다",0,R.raw.millitary24));
    ...
    public static ArrayList<MyData> real = new ArrayList<MyData>(){
        {
            ...
            add(new MyData("다음 생에",0,R.raw.real29));
    ...
    public static ArrayList<MyData> college = new ArrayList<MyData>(){
        {
            ...
            add(new MyData("천안시 D대학교 괴담", 0, R.raw.college12 ));
            add(new MyData("아산시 H대학교 괴담", 0, R.raw.college13 ));
            add(new MyData("청주시 C대학교 괴담", 0, R.raw.college14 ));
            add(new MyData("세종시 K대학교 괴담", 0, R.raw.college15 ));
            add(new MyData("춘천시 K대학교 괴담", 0, R.raw.college16 ));
            add(new MyData("춘천시 H대학교 괴담", 0, R.raw.college17 ));
            add(new MyData("사하구 D대학교 괴담", 0, R.raw.college18 ));
            add(new MyData("금정구 B대학교 괴담", 0, R.raw.college19 ));
            add(new MyData("영도구 H대학교 괴담", 0, R.raw.college20 ));
            add(new MyData("진주시 K대학교 괴담", 0, R.raw.college21 ));
            add(new MyData("광산시 K대학교 괴담", 0, R.raw.college22 ));
            add(new MyData("북구 J대학교 괴담", 0, R.raw.college23 ));
            add(new MyData("동구 J대학교 괴담", 0, R.raw.college24 ));
    ...
    {
        {
            ...
            add(new MyData("연상녀",0, R.raw.imui16));
            ...
            add(new MyData("꿈",0, R.raw.imui25));
    ...
    {
        {
            add("산속깊은곳인데 인기메뉴가 있을리가 없다. 사람을 죽여서 그 고기로 다시 나폴리탄을 만든 것");
            ...
            add("남자는 상자속에 갇혔다. 남자의 목이 잘려 돈과 함께 들어가 있다"); // 답변 넣기
            ...
            add("눈이 크고 아름답고 마치 나를 쳐다보는 느낌이 들었다. 근데 작품의 제목은 잠자는 미녀. 딸의 잠자는 모습을 그림. \n" +
                    "그러므로 눈을 뜨고 있을리 없다");
            ...
            add("내가 아직도 니 엄마로 보이니");
            add("티비를 켜기전 검은화면에 비친 나를 아이는 가리켰다");
            add("나는 밧줄에 대한것을 언급하지 않았다.근데 친구는 알고있었다.친구가 나를 죽이려고 일부로 밧줄을 끊었다");
            add("친구가 다음엔 진짜 병문안을 온다고 했는데,  병문안을 온것이 아니라면 친구는 무엇을 말하려고 온 것일까? 범인은 친구다"); // 답변 넣기
            add("존은 흑인이다");
            add("처음 규칙을 어겼을때 새엄마는 오른쪽 손을 잘랐다. 그래서 왼쪽으로 쓰는 것이 힘들었다. \n" +
                    "두 번째로 규칙을 어겼을 땐 왼쪽 손목을 잘라서 결국 입으로 쓰는 것. 그래서 대답하지 못했다. 연필을 입에 물고 있었기 때문에");
            add("우물 안은 귀신 천지");
            add("죽은 사람이 메일을 보내는 것은 불가능하다");
            add("사건의 범인은 여동생. 오빠는 여동생을 감싸고 스스로 사형당했다. 오빠가 죽인 한 사람은 자기 자신"); // 답변 넣기
            add("여자친구가 쓰러진 장소를 어떻게 알았지?");
            add("만약 그 수박이 익었더라면...?");
            add("시간이 멈춰진 사람들은 어떻게 하지?");
            add("그리고 나는 열쇠가 없다");
            add("베란다 난간위에 올라가있었다"); // 답변 넣기
            add("할머니가 목을 메 죽어있었던 것");
            ...
            add("임신을 하느니 생리가 낫다. 둘은 근친 상간을 하는 오빠 동생이다");
            add("남자는 죽은 귀신이다");
